...
public class UpdateServlet extends HttpServlet {
            ...
            throws ServletException, IOException
    {
        ...
        String cod =request.getParameter("codDepartament");
        String nume =request.getParameter("denumire");
       ...
       /* out.println("<h1>" + name + "</h1>");
        ...
        String sql = "UPDATE departament SET Denumire_Departament='"+nume+"' WHERE Cod_Departament="+Integer.parseInt(cod)+"";
